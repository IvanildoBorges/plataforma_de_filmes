...
public class FindFaixaEtaria extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FindFaixaEtaria
     */
    public FindFaixaEtaria() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista de filmes pela classificação etária escolhida");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(210, 120, 560, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindFaixaEtaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FindFaixaEtaria().setVisible(true);
            }
        });
    }
