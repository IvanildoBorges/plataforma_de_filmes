  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Email", "Senha", "Telefone", "Endereço", "Data de Aniversário"
            }
        ) {
    ...
    public Date convertToDate(String aniversario){
        String niver =  aniversario;
        String formator = "yyyy/MM/dd";
        SimpleDateFormat formatador = new SimpleDateFormat();
        
        try {
            formatador.applyPattern(formator);
            Date dataFormatada = (Date) formatador.parse(niver);
            return dataFormatada;
        } catch (Exception e) {
            e.printStackTrace();
        }
